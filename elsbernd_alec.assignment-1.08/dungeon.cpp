...
int gen_dungeon(dungeon *d)
{
  ...
  for(std::vector<object_description>::size_type i = 0; i < d->object_descriptions.size(); i++) {
    ...
    temp->type = d->object_descriptions[i].type;
    temp->color = d->object_descriptions[i].color;
    temp->hit = d->object_descriptions[i].hit.roll();
    temp->damage = d->object_descriptions[i].damage;
    temp->dodge = d->object_descriptions[i].dodge.roll();
    temp->defence = d->object_descriptions[i].defence.roll();
    temp->weight = d->object_descriptions[i].weight.roll();
    temp->speed = d->object_descriptions[i].speed.roll();
    temp->attribute = d->object_descriptions[i].attribute.roll();
